...
**画面概要**：登録済みの顧客を一覧表示する。ここから請求書の作成、または顧客の新規登録・編集へ進む。
...
| 項目名 | 内容 | 備考 |
|---|---|---|
| 顧客ID | `Customer.customerId` | 選択した顧客の情報を標示 |
...
- 発行時にサーバー側で再検証し、顧客が存在しない・明細が0件などのばあいはエラーとして SCR-002 へ戻す。

---

## SCR-004 請求書発行完了画面

**画面概要**：請求書の発行が完了したことを利用者に通知し、次へ誘導する。
